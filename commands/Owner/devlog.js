...
class DevLog extends Command {
  ...
  run (message, args) {
    try {
      ...
      const chan = this.client.guilds.cache.find(g => g.id === '697368051405815860').channels.cache.find(c => c.id === '740500133921423440')
      if (!chan) {
