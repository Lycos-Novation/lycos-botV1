...
**Parole rendue automatiquement**`,
			...
			MEMBERCOUNT_NO_METHOD: "Veuillez indiquer dans quoi voulez-vous faire apparaître votre compteur : channel/category. Vous pouvez ajouter le nom que vous voulez donner au salon en utilisant ``{membercount}`` là où vous voulez que le nombre de mmebre apparaîsse dans le nom de votre salon.",
