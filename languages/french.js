...
module.exports = class {
	constructor(...args) {
		this.language = {
			...
			SERVERINFO_ROLELIST: (guild) => `et ${guild.roles.cache.size - 10} autres rôles.`,
			DATE_AGO: "Il y a ",
			DATE_DAY: " jour",
			DATE_DAYS: " jours",
			...
			USERINFO_ROLELIST: (member) => `et ${member.roles.cache.size - 10} autres rôles.`,
...
**Précipitations :** ${result[0].forecast[4].precip}%`,
			...
			REPORT_SEND: "Votre signalement a été signalé !",
...
**Parole rendue automatiquement**`,
			...
			RR_NOT_IN: "Ce rôle n'est pas dans le role reaction.",
			...
			RR_SUPPLY_DESCRIPTION: "Veuillez fourir une courte description du rôle. Vous ne pouvez pas utilier le caractère `/` dans votre description.",
